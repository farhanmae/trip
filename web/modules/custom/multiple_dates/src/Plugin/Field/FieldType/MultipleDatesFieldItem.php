<?php
namespace Drupal\multiple_dates\Plugin\Field\FieldType;
...
/**
* Plugin implementation of the 'multiple_dates' field type.
*
* @FieldType(
*   id = "multiple_dates",
*   label = @Translation("Multiple Dates"),
*   description = @Translation("Stores dates"),
*  category = @Translation("Multiple Dates Field"),
*   default_widget = "multiple_dates_default_widget",
*   default_formatter = "multiple_dates_default_formatter"
* )
*/
class MultipleDatesFieldItem extends FieldItemBase implements FieldItemInterface {
    ...
    {
        $properties['multiple_dates'] = DataDefinition::create('string')
        ->setLabel(t('MultipleDates'));
        return $properties;
    }
        ...
        return array(
            'columns' => array(
                'multiple_dates' => array(
                    'description' => 'Comma-separated list of multiple dates for this entry.',
                    'type' => 'text',
                    'size' => 'big',
                    'not null' => FALSE,
                ),
    ...
    public function isEmpty() {
        return empty($this->get('multiple_dates')->getValue());
    }
